...
def test_cart_checkout(product_page, cart_page, checkout_pages, logger):
    ...
    expect(checkout_two_page.page).to_contain_text("Payment Information")
    expect(checkout_two_page.page).to_contain_text("Shipping Information")
    expect(checkout_two_page.page).to_contain_text("Price Total")
